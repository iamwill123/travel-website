    ...
    <div className="recommendation-card">
      ...
      {recommendation.imageUrl && (
        <div className="card-image">
          ...
          />
          <div className={`category-badge ${getCategoryClass(recommendation.category)}`}>
      ...
      <div className="card-content">
        ...
        <div className="tips-section">
          <h4 className="tips-title">💡 Travel Tip</h4>
          <p className="tips-content line-clamp-2">
            {recommendation.tips}
          </p>
        </div>
        ...
        <div className="card-footer">
          <div className="author">
            <div className="author-avatar">
              {recommendation.author.charAt(0).toUpperCase()}
            </div>
